...
const DECK_DATA = {
  editions: [
    ...
    { id:'j22', name:'Jumpstart 2022', year:2022, code:'J22', decks:[
      ...
      { id:'j22-death', name:'Death', colors:['B'], headliner:'Grave Titan', variants:[{label:'Grave Titan',cards:[]}]},
      ...
      { id:'j22-heroes', name:'Heroes', colors:['W'], headliner:'Starnheim Courser', variants:[{label:'Starnheim',cards:[]}]},
      { id:'j22-lore', name:'Lore', colors:['U'], headliner:'Sage of the Falls', variants:[{label:'Sage',cards:[]}]},
